...
<div>
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="input-group">
              <div style="margin-right: 40px;"> <!-- Adjusted margin-right for spacing -->
            ...
            <div class="input-group">
                <div>
                    <label for="health_info"><b>Tell us about your health:</b></label>
                    <textarea id="health_info" name="health_info" placeholder="Health Information"></textarea>
                </div>
            </div>
            <div>
